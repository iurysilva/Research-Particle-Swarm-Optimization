...
def Bukin6(x,swarm):
    swarm.limits= np.array([-15,3],dtype="int64")
    swarm.function_minimum= np.array([-10,1])
...
def Eggholder(x,swarm):
    swarm.limits= np.array([-512,512],dtype="int64")
    swarm.function_minimum= np.array([512,404.2319])
